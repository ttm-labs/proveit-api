...
goog.exportSymbol('proto.organization_service.GetOrganizationIDsForUserAdminRequest', null, global);
goog.exportSymbol('proto.organization_service.GetOrganizationIDsForUserAdminResponse', null, global);
 ...
 * @constructor
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.organization_service.GetOrganizationIDsForUserAdminRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.organization_service.GetOrganizationIDsForUserAdminRequest.displayName = 'proto.organization_service.GetOrganizationIDsForUserAdminRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.organization_service.GetOrganizationIDsForUserAdminResponse.repeatedFields_, null);
};
goog.inherits(proto.organization_service.GetOrganizationIDsForUserAdminResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.organization_service.GetOrganizationIDsForUserAdminResponse.displayName = 'proto.organization_service.GetOrganizationIDsForUserAdminResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.organization_service.GetOrganizationIDsForUserAdminRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.organization_service.GetOrganizationIDsForUserAdminRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminRequest}
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.organization_service.GetOrganizationIDsForUserAdminRequest;
  return proto.organization_service.GetOrganizationIDsForUserAdminRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.organization_service.GetOrganizationIDsForUserAdminRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminRequest}
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.organization_service.GetOrganizationIDsForUserAdminRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.organization_service.GetOrganizationIDsForUserAdminRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.organization_service.GetOrganizationIDsForUserAdminRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.organization_service.GetOrganizationIDsForUserAdminResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.organization_service.GetOrganizationIDsForUserAdminResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminResponse}
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.organization_service.GetOrganizationIDsForUserAdminResponse;
  return proto.organization_service.GetOrganizationIDsForUserAdminResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.organization_service.GetOrganizationIDsForUserAdminResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminResponse}
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.organization_service.GetOrganizationIDsForUserAdminResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.organization_service.GetOrganizationIDsForUserAdminResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.prototype.getOrganizationIdsList = function() {
 ...
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminResponse} returns this
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.prototype.setOrganizationIdsList = function(value) {
 ...
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminResponse} returns this
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.prototype.addOrganizationIds = function(value, opt_index) {
 ...
 * @return {!proto.organization_service.GetOrganizationIDsForUserAdminResponse} returns this
 */
proto.organization_service.GetOrganizationIDsForUserAdminResponse.prototype.clearOrganizationIdsList = function() {
...
proto.organization_service.UserInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tsLastLogin: (f = msg.getTsLastLogin()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
  };
 ...
 * @return {string}
 */
proto.organization_service.UserInfo.prototype.getEmail = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.organization_service.UserInfo} returns this
 */
proto.organization_service.UserInfo.prototype.setEmail = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.organization_service.UserInfo.prototype.getFirstName = function() {
 ...
 * @return {!proto.organization_service.UserInfo} returns this
 */
proto.organization_service.UserInfo.prototype.setFirstName = function(value) {
 ...
 * @return {string}
 */
proto.organization_service.UserInfo.prototype.getLastName = function() {
 ...
 * @return {!proto.organization_service.UserInfo} returns this
 */
proto.organization_service.UserInfo.prototype.setLastName = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional google.protobuf.Timestamp ts_last_login = 5;
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.organization_service.UserInfo.prototype.getTsLastLogin = function() {
 ...
 * @return {!proto.organization_service.UserInfo} returns this
*/
proto.organization_service.UserInfo.prototype.setTsLastLogin = function(value) {
 ...
 * @return {!proto.organization_service.UserInfo} returns this
 */
proto.organization_service.UserInfo.prototype.clearTsLastLogin = function() {
  return this.setTsLastLogin(undefined);
};
 ...
 * @return {boolean}
 */
proto.organization_service.UserInfo.prototype.hasTsLastLogin = function() {
